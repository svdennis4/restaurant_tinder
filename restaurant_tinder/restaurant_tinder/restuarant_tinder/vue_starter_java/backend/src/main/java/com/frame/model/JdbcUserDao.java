...
public class JdbcUserDao implements UserDao {
    ...
    public User getUserByUsername(String username) {
        String sqlSelectUserByUsername = "SELECT id,email,username, role FROM users WHERE username = ?";
    ...
    @Override
	public void setPreferences(long id, Preferences pref) {
		...
		for(Integer p : pref.getPreferences()) {
			int result = jdbcTemplate.update(sqlInsertPreferences, id, p);
		}
